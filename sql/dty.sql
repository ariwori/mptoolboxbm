...
-- ----------------------------
-- Table structure for dty_record
-- ----------------------------
DROP TABLE IF EXISTS `dty_record`;
CREATE TABLE `dty_record`  (
  ...
  `dingche` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `dingcan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `createTime` timestamp(0) NULL DEFAULT NULL,
  `yudingDate` timestamp(0) NULL DEFAULT NULL,
  `timecode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`rid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for dty_user
-- ----------------------------
DROP TABLE IF EXISTS `dty_user`;
CREATE TABLE `dty_user`  (
  `uid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `wxid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `depart` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of dty_user
-- ----------------------------
INSERT INTO `dty_user` VALUES ('1', 'sssss', '林维清', '应用研发分院', NULL);
